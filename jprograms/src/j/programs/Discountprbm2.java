...
public class Discountprbm2 {
	...
	static float dics(float i, float s, float t, float n)
	{
		...
		if(total_amt>25_000 && total_amt<=50_000)
		{
			...
			System.out.print("whole_product Discount "+whole_dis);
		...
		{
			System.out.print("Take the per_product Discount "+ (totaldis_per_product - whole_dis)+ " Is more discount & discount "+totaldis_per_product );
			return   totaldis_per_product;
		}
		else
		{
			System.out.print("Take the whole_product Discount "+ (whole_dis- totaldis_per_product)+ " Is more discount & discount "+whole_dis);
			return  whole_dis;
		}
